...
@section('head_and_title')
    ...
    <section>
        <div class="container">
            <div class="row px-5">
                <div class="col-4">
                    <div style="background-image: url('{{ asset('images/31ss/hotel/website34.jpg') }}');
                        background-repeat: no-repeat;
                        background-position: center;
                        background-size: contain;
                        height: 400px;">
                ...
                <div class="col-6">
                    <div class="mt-5 pb-3" style="background-image: url('{{ asset('images/31ss/hotel/hyattplacelogo.png') }}');
                        background-repeat: no-repeat;
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-12" style="background-image: url('{{ asset('images/31ss/hotel/website35.jpg') }}');
                    background-repeat: no-repeat;
                    background-position: center;
                    background-size: contain;
                    height: 400px;">
    ...
    <section class="mt-5">
        <div class="container">
            <div class="row px-5 mx-5">
                ...
                <div class="col-4" style="background-image: url('{{ asset('images/31ss/hotel/website37.jpg') }}');
                    background-repeat: no-repeat;
                    background-position: center;
                    background-size: contain;
                    height: 300px;">     
                </div>
                <div class="col-4" style="background-image: url('{{ asset('images/31ss/hotel/website38.jpg') }}');
                    background-repeat: no-repeat;
                    background-position: center;
                    background-size: contain;
                    height: 300px;">     
                </div>
                <div class="col-4" style="background-image: url('{{ asset('images/31ss/hotel/website39.jpg') }}');
                    background-repeat: no-repeat;
                    background-position: center;
                    background-size: contain;
                    height: 300px;">     
                </div>
                <div class="col-4" style="background-image: url('{{ asset('images/31ss/hotel/website40.jpg') }}');
                    background-repeat: no-repeat;
                    background-position: center;
                    background-size: contain;
                    height: 300px;">     
                </div>
                <div class="col-4" style="background-image: url('{{ asset('images/31ss/hotel/website47.jpg') }}');
                    background-repeat: no-repeat;
                    background-position: center;
                    background-size: contain;
                    height: 300px;">     
