...
<head>
    ...
    <title>31 Sudirman Suites - Contact Message</title>
    <style type="text/css">
                        ...
                        <tr>
                            <td align="left" valign="top">
                                ...
                                <div class="mobile-full" style="display: inline-block; max-width: 166px; vertical-align: top; width: 100%;">
                                    <a href="http://31sudirmansuites.com/" style="font-size: 18px; font-family: Arial, Helvetica, sans-serif; color: #f3f3f3; text-decoration: none;" target="_new"><img alt="" border="0" hspace="0" src="http://31sudirmansuites.com/public/images/31ss/website1-05.png" style="border: 0px;display: block;width: 100%;max-width: 166px;" vspace="0" width="166"></a>
            ...
            <td align="center" bgcolor="#fff" class="vb-outer" style="padding-left: 9px;padding-right: 9px;background-color: #fff;" valign="top">
                ...
                <div class="oldwebkit" style="max-width: 650px;">
                    <table bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="9" class="vb-container halfpad" style="border-collapse: separate;border-spacing: 9px;padding-left: 9px;padding-right: 9px;width: 100%;max-width: 650px;background-color: #fff;" width="650">
                        <tbody>
                        <tr>
                            <td align="center" bgcolor="#FFFFFF" style="background-color: #ffffff; font-size: 14px; font-family: Verdana, Geneva, sans-serif; color: #3f3f3f; text-align: center; line-height: 1.6;"><span>Contact us : info@31sudirmansuites.com</span></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
